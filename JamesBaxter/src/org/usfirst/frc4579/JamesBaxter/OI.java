...
import org.usfirst.frc4579.JamesBaxter.subsystems.*;
...
public class OI {
    ...
    public JoystickButton togButton;
    ...
    public OI() {
        ...
        togButton = new JoystickButton(joystick, 6);
        togButton.whenPressed(new sToggle());
